...
{//加上头部8个字节，这里有92个字节，一共一百个字节
	...
	unsigned long long payload4;
	unsigned long long payload5;
	unsigned long long payload6;
	unsigned long long payload7;
	unsigned long long payload8;
	unsigned long long payload9;
	unsigned long long payload10;
};

struct STestNetworkAsk
{
	STestNetwork ask;
};

struct STestNetworkRsp
{
	STestNetwork rsp;
};
