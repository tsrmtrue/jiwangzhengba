...
enum EProtocolId
{
	...
	C_2_S_Test_Network_Ask,	//STestNetworkAsk，测试网络请求
	S_2_C_Test_Network_Rsp,	//STestNetworkRsp，测试网络回复
...
enum EObjectAction
{
    ...
    public class STestNetwork
    {
        public Int32  idx = 0;
        public UInt64  time = 0;
        public UInt64  payload1 = 0;
        public UInt64  payload2 = 0;
        public UInt64  payload3 = 0;
        public UInt64  payload4 = 0;
        public UInt64  payload5 = 0;
        public UInt64  payload6 = 0;
        public UInt64  payload7 = 0;
        public UInt64  payload8 = 0;
        public UInt64  payload9 = 0;
        public UInt64  payload10 = 0;
    ...
    public class STestNetworkAsk
    {
        public STestNetwork  ask =  new STestNetwork();
        ...
        public bool decode(byte [] __buff__, ref int __used__)
        {
...

            {
                for (int __i__=0; __i__<1; ++__i__)
                {
                    STestNetwork __t__ = new STestNetwork();
                    if (! __t__.decode(__buff__, ref __used__) )
                    {
                        return false;
                    }
        ...
        public bool encode(ref byte[] __buff__, ref int __used__)
        {
...

            {
                for (int __i__=0; __i__<1; ++__i__)
                {
                    if (! ask.encode(ref __buff__, ref __used__) )
                    {
                        return false;
                    }
                }
    ...
    public class STestNetworkRsp
    {
        public STestNetwork  rsp =  new STestNetwork();
        ...
        public bool encode(ref byte[] __buff__, ref int __used__)
        {
...

            {
                for (int __i__=0; __i__<1; ++__i__)
                {
                    if (! rsp.encode(ref __buff__, ref __used__) )
                    {
                        return false;
                    }
                }
